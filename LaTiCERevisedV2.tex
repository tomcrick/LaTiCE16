...
\iffalse
A few years ago I was in Bath for an HEA meeting presenting the
"programming and discrete mathematics" course for first-year
undergraduate, which I found a great idea.  We're a planning to start
a similar course next year in Reading and we are now deciding the
content.  May I ask you if I can have some syllabus or lecture notes
to have some more precise idea of what is done in Bath?
\fi
...
than it is a purely theoretical subject. Hence an ``apprenticeship'' model,
...
%Our objective in the second case (matching) is to ensure that stronger undergraduates interact with technically stronger tutors and weaker students with better teachers. 
...
\bibitem{brown-et-al-sigcse2013}
